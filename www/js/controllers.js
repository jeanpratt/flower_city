...
.controller('MapCtrl', function($scope, places) {
	...
	places.success(function(data) {
		...
		var createMarker = function(info){
			...
			--------------------------------------*/
			var pin = {
				path: 'M444.2,222.1C444.2,99.4,344.8,0,222.1,0S0,99.4,0,222.1c0,45.6,13.8,88,37.3,123.3h-0.1l1.2,1.5c4.2,6.2,8.7,12.1,13.5,17.8l170.3,225l170.3-225c4.8-5.7,9.3-11.6,13.5-17.8l1.2-1.5h-0.1C430.5,310.1,444.2,267.7,444.2,222.1z',
				fillColor: "#8A55AA",
				fillOpacity: 1,
				scale: 0.07,
				strokeColor: '#8A72CC',
			...
			- Question: 		"Google Maps V3 marker with label"
			- Asker: 			Adrian Florescu
			- Answerer: 		Ramyani 
			- Link: 			http://stackoverflow.com/q/11096094
			--------------------------------------*/
			
			var markerSize = { x: -7, y: 33 };
			...
			var MarkerLabel = function(options) {
		        ...
		        this.span.className = 'markerLabel';
		    };
